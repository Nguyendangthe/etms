...
function format(d) {
    return '<div class="detail-panel-block" style="display: block">' +
                '<div class="row title-row">' +
                    '<div class="col-xs-4">' +
                        '<span>Code: P00000370</span>' +
                    '</div>' +
                    '<div class="col-xs-4">' +
                        '<span>Name (VI): Quy Đức</span>' +
                    '</div>' +
                    '<div class="col-xs-4">' +
                        '<span>Name (EN): Quy Đức</span>' +
                    '</div>' +
                '</div>' +
                '<div class="row detail-row">' +
                    ...
                    '<div class="col-xs-4">' +
                        ...
                        '<span>Pickup Zone: V</span>' +
                        '<span>GeoCode: 10.812704, 106.66350829999999</span>' +
                    '</div>' +
                    '<div class="col-xs-4">' +
                        '<span>Postal Code: 023</span>' +
...
function tableDatatableCollapse() {
    var table = $('.tableDatatableCollapse').DataTable({
        "searching": false,
    ...
    $('.tableDatatableCollapse tbody').on('click', '.table-action-col .btn-collapse', function() {
